...
namespace BeckhoffSearch
{
    ...
    public sealed class BeckhoffBroadcastSearcher : IDisposable
    {
        ...
        public List<BeckhoffDeviceInfo> SearchBroadcast(
            string broadcastIp,
            int timeoutMs = 3000)
        {
        ...
        public List<BeckhoffDeviceInfo> SearchUnicast(
            string targetIp,
            int timeoutMs = 3000)
        {
        ...
        private List<BeckhoffDeviceInfo> Search(IPAddress targetIp, int timeoutMs)
        {
            var result = new List<BeckhoffDeviceInfo>();
            ...
            while (DateTime.Now < deadline)
            {
                try
                {
                    ...
                    string key = $"{device.IpAddress}-{device.AmsNetId}";
        ...
        private static BeckhoffDeviceInfo? ParseResponse(IPEndPoint remote, byte[] data)
        {
